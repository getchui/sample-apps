...
// This sample app demonstrates how to use 1N identification. First, an existing collection (created
// by running enroll_in_database) is loaded from disk. Next, 1N identification is run to determine
// the identity of an anonymous template. Note, you must run enroll_in_database before being able to
// run this sample app.
